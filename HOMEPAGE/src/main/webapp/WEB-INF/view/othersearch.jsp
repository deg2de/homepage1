...
<link rel="stylesheet" type="text/css" href="CSS/otherlist.css">
...
<body>
	...
	<div id="otherlist">
		<div id="otherlist_maintext">Other</div>
		<div id="upbutton">
			<table>
			<tr>
				<td>
				...
				<td>
					<form action="otherwrite" method="get">
		...
		<div id="list">
			<table id="tablealign">
				...
				<c:forEach var="other" items="${otherlist}">
					<tr>
						<td id="list_no">${other.listno}</td>
						<td id="list_type">${other.othtype}</td>
						<td id="list_title">
							<a href="otherread?list_no=${other.listno}" id="list_titletext">${other.title}</a>
						</td>
						<td id="list_name">${other.userid}</td>
						<td id="list_date">${other.othdate}</td>
						<td id="list_readcount">${other.othcount}</td>
					</tr>
				</c:forEach>
				</tbody>
			</table>
		...
		<div id="listpageno">
			...
			<tr>
				<c:if test="${nowlistpageno != 1}">
					<td>
					<form action="otherlist" method="post">
					<input type="hidden" name="searchothtype" value="${searchothtype}">
		...
		<div id="search">
		<form action="otherlist" method="post">
			<select name="searchothtype" id="searchtype">
				<option value="oth_title">제목</option>
				<option value="oth_titletext">제목+내용</option>
				<option value="oth_type">종류</option>
				<option value="oth_name">작성자</option>
			</select>
