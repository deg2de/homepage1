...
<link rel="stylesheet" type="text/css" href="CSS/othersuccess.css">
...
<body>
	...
	<div id="othersuccess">
		<div id="othersuccess_maintext">Other Page</div>
		<div id="othersuccess_text">${message}</div>
		<div id="othersuccess_text_listbutton">
			<form action="otherlist" method="get">
				<input type="hidden" name="pageno" value="${1}">
				<input type="submit" value="Other" id="othersuccess_listbutton">
			</form>
		</div>
	</div>
